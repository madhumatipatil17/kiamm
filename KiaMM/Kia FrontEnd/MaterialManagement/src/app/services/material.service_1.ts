...
import {Orders} from '../placeorder/orders';
...
export class MaterialService {
  ...
  url: string = "http://localhost:8080/MmProdReqHeaderEntity/ordered/";
  requesterurl: string = "http://localhost:8080/MmProdReqHeaderEntity/requester/";
...
//for requesterdetails
  public updatestatustoRecived(reqnbr: string) {
    return this.http.get("http://localhost:8080/MmProdReqHeaderEntity/recived/" + reqnbr)
  }
